...
class Car:
    image_car = [
        "image/RacingCar01.png",
        "image/RacingCar02.png",
        "image/RacingCar03.png",
        "image/RacingCar04.png",
        "image/RacingCar05.png",
        "image/RacingCar06.png",
        "image/RacingCar07.png",
        "image/RacingCar08.png",
        "image/RacingCar09.png",
        "image/RacingCar10.png",
        "image/RacingCar11.png",
        "image/RacingCar12.png",
        "image/RacingCar13.png",
        "image/RacingCar14.png",
        "image/RacingCar15.png",
        "image/RacingCar16.png",
        "image/RacingCar17.png",
        "image/RacingCar18.png",
        "image/RacingCar19.png",
        "image/RacingCar20.png",
    ]
    ...
    def check_crash(self, car):
        if (
            ...
            and (self.x < car.x + car.width)
            and (self.y < car.y + car.height)
            and (self.y + self.height > car.y)
        ):
            return True
        else:
            return False
...
def draw_main_menu():
    ...
    image_intro = pygame.image.load("image/PyCar.png")
    ...
    text_start = font_40.render("Press Space Key to Start!" + str(score), True, RED)
...
if __name__ == "__main__":
    ...
    pygame.mixer.music.load("music/race.wav")
    sound_crash = pygame.mixer.Sound("music/crash.wav")
    sound_engine = pygame.mixer.Sound("music/engine.wav")
    ...
    while game_on:
        ...
        if not crash:
            for i in range(lane_count):
                pygame.draw.rect(
                    screen, WHITE, [lanes[i][0], lanes[i][1], lane_width, lane_height]
                )
                lanes[i][1] += 10
